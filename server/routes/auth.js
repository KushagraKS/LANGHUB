...
router.post('/register', [
  ...
  body('learningLanguages').isArray({ min: 1 }).withMessage('At least one learning language is required')
], async (req, res) => {
  try {
    ...
    const { name, email, password, nativeLanguage, learningLanguages, bio, interests } = req.body;
